...
PATH=/home/vagrant/hadoop/bin/:$JAVA_HOME/bin:$JAVA_HOME/jre/bin:$HOME/pig/bin:$HIVE_HOME/bin:$HBASE_HOME/bin:~/bin:$PATH
...
export CLASSPATH=$JAVA_HOME/lib:$JAVA_HOME/jre/lib:/home/vagrant/hadoop/lib:/home/vagrant/hadoop/share/hadoop:$HIVE_HOME/lib:$HBASE_HOME/lib:$CLASSPATH
