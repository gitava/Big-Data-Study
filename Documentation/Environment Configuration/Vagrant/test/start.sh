...
sudo ssh-copy-id -i /root/.ssh/id_rsa.pub root@hdp-node-04
...
sudo $HADOOP_HOME/bin/hadoop jar hadoop-mapreduce-examples-2.9.2.jar wordcount /wordcount/input /wordcount/output
